...
extension UIView : CAAnimationDelegate {
    ...
    public func addProgressArchAnimation(lineSize: CGSize, value: CGFloat, fillColor: UIColor, backgroundLineColor: UIColor, colorsGradient: [UIColor], containtsLabel: Bool = false, labelText : String = "", labelColor : UIColor = .clear, subtitleText: String = "", subtitleColor : UIColor = .lightGray) {
    ...
    public func addProgressCircleAnimation(lineSize: CGSize, value: CGFloat, fillColor: UIColor, backgroundLineColor: UIColor, colorsGradient: [UIColor], containtsLabel: Bool = false, labelText : String = "", labelColor : UIColor = .clear, subtitleText: String = "", subtitleColor : UIColor = .lightGray) {
    ...
    private func generateGradient(trackColors : [UIColor], frame: CGRect) -> CAGradientLayer {
